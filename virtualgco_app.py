...
def gco_chatbot(user_input):
    # Collect the entire message history
    ...
    full_response = f"{answer}\n\n📄 *Supporting Documents:*\n{docs_preview}" if docs else answer
